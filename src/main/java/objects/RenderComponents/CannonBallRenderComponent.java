...
public class CannonBallRenderComponent extends RenderComponent {

    static Image cannonBall = new Image("file:src/main/resources/cannonball.png");
    static int[] falseRand = {8, 3, 7, 1, 5, 4, 9, 6, 2, 0};
    private int life = 0;

    public CannonBallRenderComponent(PositionComponent pos) {
        super(pos);
    }
    ...
    public void toRender(GraphicsContext gc) {
        ...
        gc.restore();
        gc.drawImage(cannonBall, (int) x.get() - 10, (int) y.get() - 10);
    }
